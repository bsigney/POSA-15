...
public class MainActivity extends LifecycleLoggingActivity {
    ...
    protected void onActivityResult(int requestCode,
        ...
        if (resultCode == RESULT_OK) {
            ...
            if (requestCode == DOWNLOAD_IMAGE_REQUEST) {
                ...
                // file.
                Intent makeGalleryIntent = makeGalleryIntent(data.getData().toString());
    ...
    private Intent makeGalleryIntent(String pathToImageFile) {
        ...
        // the image.
    	Log.i(TAG, "makeGalleryIntent: " + pathToImageFile);
        Intent intent = new Intent(Intent.ACTION_VIEW, Media.EXTERNAL_CONTENT_URI);
        File imageFile = new File(pathToImageFile);
        Uri imageUri = Uri.fromFile(imageFile);
        intent.setDataAndType(imageUri, MimeTypeMap.getSingleton().getMimeTypeFromExtension("png"));
